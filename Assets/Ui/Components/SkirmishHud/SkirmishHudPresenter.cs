...
{
    internal sealed class SkirmishHudPresenter
    {
        private readonly ISkirmishUiSession session;
        ...
        public SkirmishHudPresenter(
            ISkirmishUiSession session,
        ...
        public void Bind(SkirmishHudView nextView, bool hideWhenInactive, CancellationToken token)
        {
            Unbind();
            view = nextView;
